...
##########################################################################
vcfDir <- "/N/dc2/projects/PromoterPopGen/human/human-split-data/gene_chr9"	 
fileList <- "/N/dc2/projects/PromoterPopGen/human/human-split-data/gene_chr9/human_file_list_9.txt"					 
