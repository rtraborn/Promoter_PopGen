...
##########################################################################
vcfDir <- "/N/dc2/projects/PromoterPopGen/human/human-split-data/gene_chr20"	 
fileList <- "/N/dc2/projects/PromoterPopGen/human/human-split-data/gene_chr20/human_file_list_20.txt"					 
