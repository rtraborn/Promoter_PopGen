...
##########################################################################
vcfDir <- "/N/dc2/projects/PromoterPopGen/human_complete_data/human-split-data/cisreg_chr8"	 
fileList <- "/N/dc2/projects/PromoterPopGen/human_complete_data/human-split-data/cisreg_chr8/human_file_list_8.txt"					 
file.names <- read.csv(file=fileList, header=FALSE)
colnames(file.names) <- c("chr", "start", "end", "file")		 
gffFile <- "/N/dc2/projects/PromoterPopGen/TSSs_gff/TSSset-1_chr8.gff3"
