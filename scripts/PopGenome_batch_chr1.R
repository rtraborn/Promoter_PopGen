...
##########################################################################
vcfDir <- "/N/dc2/projects/PromoterPopGen/human/human-split-data/gene_chr1"	 
fileList <- "/N/dc2/projects/PromoterPopGen/human/human-split-data/gene_chr1/human_file_list_1.txt"					 
