...
##########################################################################
vcfDir <- "/N/dc2/projects/PromoterPopGen/human/human-split-data/gene_chr6"	 
fileList <- "/N/dc2/projects/PromoterPopGen/human/human-split-data/gene_chr6/human_file_list_6.txt"					 
