...
##########################################################################
vcfDir <- "/N/dc2/projects/PromoterPopGen/human/human-split-data/gene_chr4"	 
fileList <- "/N/dc2/projects/PromoterPopGen/human/human-split-data/gene_chr4/human_file_list_4.txt"					 
