...
##########################################################################
vcfDir <- "/N/dc2/projects/PromoterPopGen/human/human-split-data/gene_chr14"	 
fileList <- "/N/dc2/projects/PromoterPopGen/human/human-split-data/gene_chr14/human_file_list_14.txt"					 
