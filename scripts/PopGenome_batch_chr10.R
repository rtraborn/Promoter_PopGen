...
##########################################################################
vcfDir <- "/N/dc2/projects/PromoterPopGen/human/human-split-data/gene_chr10"	 
fileList <- "/N/dc2/projects/PromoterPopGen/human/human-split-data/gene_chr10/human_file_list_10.txt"					 
