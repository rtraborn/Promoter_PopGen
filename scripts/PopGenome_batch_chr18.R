...
##########################################################################
vcfDir <- "/N/dc2/projects/PromoterPopGen/human/human-split-data/gene_chr18"	 
fileList <- "/N/dc2/projects/PromoterPopGen/human/human-split-data/gene_chr18/human_file_list_18.txt"					 
