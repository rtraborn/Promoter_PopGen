...
##########################################################################
vcfDir <- "/N/dc2/projects/PromoterPopGen/human/human-split-data/gene_chr12"	 
fileList <- "/N/dc2/projects/PromoterPopGen/human/human-split-data/gene_chr12/human_file_list_12.txt"					 
