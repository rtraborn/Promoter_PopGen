...
##########################################################################
vcfDir <- "/N/dc2/projects/PromoterPopGen/human_complete_data/human-split-data/gene_chr12"	 
fileList <- "/N/dc2/projects/PromoterPopGen/human_complete_data/human-split-data/gene_chr12/human_file_list_12.txt"					 
file.names <- read.csv(file=fileList, header=FALSE)
colnames(file.names) <- c("chr", "start", "end", "file")		 
gffFile <- "/N/dc2/projects/PromoterPopGen/genes_gff/Homo_sapiens.GRCh38.90.chromosome.12.gff3"
