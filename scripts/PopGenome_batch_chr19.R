...
##########################################################################
vcfDir <- "/N/dc2/projects/PromoterPopGen/human/human-split-data/gene_chr19"	 
fileList <- "/N/dc2/projects/PromoterPopGen/human/human-split-data/gene_chr19/human_file_list_19.txt"					 
