...
##########################################################################
vcfDir <- "/N/dc2/projects/PromoterPopGen/human/human-split-data/cisreg_chr18"	 
fileList <- "/N/dc2/projects/PromoterPopGen/human/human-split-data/cisreg_chr18/human_file_list_18.txt"					 
file.names <- read.csv(file=fileList, header=FALSE)
colnames(file.names) <- c("chr", "start", "end", "file")		 
gffFile <- "/N/dc2/projects/PromoterPopGen/TSSs_gff/TSSset_human_chr_18_updated.gff3"
