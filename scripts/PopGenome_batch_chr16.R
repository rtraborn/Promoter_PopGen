...
##########################################################################
vcfDir <- "/N/dc2/projects/PromoterPopGen/human/human-split-data/gene_chr16"	 
fileList <- "/N/dc2/projects/PromoterPopGen/human/human-split-data/gene_chr16/human_file_list_16.txt"					 
