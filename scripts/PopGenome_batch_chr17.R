...
##########################################################################
vcfDir <- "/N/dc2/projects/PromoterPopGen/human/human-split-data/gene_chr17"	 
fileList <- "/N/dc2/projects/PromoterPopGen/human/human-split-data/gene_chr17/human_file_list_17.txt"					 
