...
##########################################################################
vcfDir <- "/N/dc2/projects/PromoterPopGen/human/human-split-data/gene_chr22"	 
fileList <- "/N/dc2/projects/PromoterPopGen/human/human-split-data/gene_chr22/human_file_list_22.txt"					 
