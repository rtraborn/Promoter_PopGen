...
##########################################################################
vcfDir <- "/N/dc2/projects/PromoterPopGen/human/human-split-data/gene_chr15"	 
fileList <- "/N/dc2/projects/PromoterPopGen/human/human-split-data/gene_chr15/human_file_list_15.txt"					 
